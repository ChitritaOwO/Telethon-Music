...
PM_START_TEXT = """
𝗛𝗲𝗹𝗹𝗼 𝗧𝗵𝗲𝗿𝗲 {}
𝗜 𝗰𝗮𝗻 𝗺𝗮𝗸𝗲 𝘆𝗼𝘂 𝗵𝗮𝗽𝗽𝘆 𝗯𝘆 𝗽𝗹𝗮𝘆𝗶𝗻𝗴 𝗺𝘂𝘀𝗶𝗰 𝗶𝗻 𝘆𝗼𝘂𝗿 𝗴𝗿𝗼𝘂𝗽 𝗰𝗮𝗹𝗹𝘀, 𝘀𝗼 𝗯𝗮𝘀𝗶𝗰𝗮𝗹𝗹𝘆 𝗶'𝗺 𝗮 𝗺𝘂𝘀𝗶𝗰 𝗯𝗼𝘁.
...
async def start(event):
    ...
    if event.is_private:
       await event.client.send_file(event.chat_id,
        ...
        [Button.url("📲 𝐑𝐞𝐠𝐢𝐬𝐭𝐞𝐫", f"http://www.9987up.cc/#/register?r_code=77678506")],
        [Button.url("📁 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", f"https://t.me/+U0N2WmZ6SzYxYjI1"), Button.url("👤 𝐂𝐨𝐧𝐭𝐚𝐜𝐭", f"https://t.me/Chitritaaa1")],
...
async def start(event):
     if event.is_group:
       await event.reply("**Register now!**",buttons=[
        [Button.url("Register Here 🤍", f"http://www.9987up.cc/#/register?r_code=77678506")]])
       return
...
async def start(event):
     if event.is_group:
       await event.reply("**I know you want to earn money, Come and join**",buttons=[
        [Button.url("Check it out 🌐", f"https://t.me/+U0N2WmZ6SzYxYjI1")]])
       return
